...
import mo.qqudah.todo.exception.ResourceNotFoundException;
...
public class TodoService {
    ...
    public TodoDto getTodoById(Long id) {
        Todo todo = todoRepositiory.findById(id).orElseThrow(() -> new ResourceNotFoundException("Todo with id " + id + " Not found"));
    ...
    public void deleteToDo(Long id) {
        todoRepositiory.findById(id).orElseThrow(() -> new ResourceNotFoundException("Todo with id " + id + " Not found"));
